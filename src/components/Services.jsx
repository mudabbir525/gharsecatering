  ...
  return (
    <div className="bg-[#FFF4E0]/30 min-h-screen">
            ...
            {serviceCategories.map((category) => (
              <div key={category.id} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-300">
                ...
                <div className="p-6">
                  ...
                  <Link to={`/services/${category.id}`} className="text-[#FF8C42] font-medium hover:text-[#FF8C42]/80 flex items-center">
                    Learn more
      ...
      <section className="py-16 bg-[#1E5631]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Special Packages</h2>
            <p className="text-white/80 max-w-2xl mx-auto">
              Choose from our curated packages designed for different occasions and preferences.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="bg-[#FF8C42]/10 p-6">
                <h3 className="text-xl font-bold text-[#2E2E2E] text-center">Essential Package</h3>
                <div className="text-center my-4">
                  <span className="text-3xl font-bold text-[#FF8C42]">₹450</span>
                  <span className="text-gray-600 ml-1">per person</span>
                </div>
                <p className="text-center text-gray-600 text-sm">Perfect for small gatherings of 10-15 people</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">3 Main Course Dishes</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">Rice and Bread</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <div className="mt-6">
                  <Link to="/book" className="block text-center bg-[#1E5631] hover:bg-[#1E5631]/90 text-white font-medium py-2 px-4 rounded-md transition duration-300">
                    Book Now
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md transform md:scale-105 z-10 relative">
              <div className="absolute top-0 right-0 bg-[#FF8C42] text-white text-xs font-bold px-3 py-1">
                POPULAR
              </div>
              <div className="bg-[#FF8C42]/10 p-6">
                <h3 className="text-xl font-bold text-[#2E2E2E] text-center">Premium Package</h3>
                <div className="text-center my-4">
                  <span className="text-3xl font-bold text-[#FF8C42]">₹650</span>
                  <span className="text-gray-600 ml-1">per person</span>
                </div>
                <p className="text-center text-gray-600 text-sm">Ideal for celebrations of 15-25 people</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">3 Starters</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">5 Main Course Dishes</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">Variety of Rice and Breads</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">Beverages included</span>
                  </li>
                </ul>
                <div className="mt-6">
                  <Link to="/book" className="block text-center bg-[#FF8C42] hover:bg-[#FF8C42]/90 text-white font-medium py-2 px-4 rounded-md transition duration-300">
                    Book Now
                  </Link>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg overflow-hidden shadow-md">
              <div className="bg-[#FF8C42]/10 p-6">
                <h3 className="text-xl font-bold text-[#2E2E2E] text-center">Deluxe Package</h3>
                <div className="text-center my-4">
                  <span className="text-3xl font-bold text-[#FF8C42]">₹850</span>
                  <span className="text-gray-600 ml-1">per person</span>
                </div>
                <p className="text-center text-gray-600 text-sm">Best for special events of 20-30 people</p>
              </div>
              <div className="p-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-600">4 Premium Starters</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">6 Main Course Specialties</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">Premium Rice and Bread Selection</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">3 Desserts</span>
                  </li>
                  <li className="flex items-start">
                    <svg className="h-5 w-5 text-[#1E5631] mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-gray-600">Premium Beverages</span>
                  </li>
                </ul>
                <div className="mt-6">
                  <Link to="/book" className="block text-center bg-[#1E5631] hover:bg-[#1E5631]/90 text-white font-medium py-2 px-4 rounded-md transition duration-300">
          ...
          <div className="mt-10 text-center">
            <p className="text-white/90 mb-4">Need a custom package? We can create one tailored to your needs.</p>
